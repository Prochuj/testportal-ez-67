...
export default function useOpenAIFiles() {
    ...
    async function uploadFile(file: File, purpose: string = "assistants"): Promise<string> {
        ...
        const response = await fetch(`${getBase()}/files`, {
            method: "POST",
            headers: {
    ...
    async function deleteFile(fileId: string): Promise<void> {
        const response = await fetch(`${getBase()}/files/${fileId}`, {
            method: "DELETE",
            headers: {
                Authorization: `Bearer ${pluginConfig.apiKey}`
            }
    ...
    async function createVectorStore(name: string): Promise<string> {
        const response = await fetch(`${getBase()}/vector_stores`, {
            method: "POST",
            headers: {
                Authorization: `Bearer ${pluginConfig.apiKey}`,
    ...
    async function deleteVectorStore(vectorStoreId: string): Promise<void> {
        const response = await fetch(`${getBase()}/vector_stores/${vectorStoreId}`, {
            method: "DELETE",
            headers: {
                Authorization: `Bearer ${pluginConfig.apiKey}`
            }
    ...
    async function addFileToVectorStore(vectorStoreId: string, fileId: string): Promise<string> {
        const response = await fetch(`${getBase()}/vector_stores/${vectorStoreId}/files`, {
            method: "POST",
            headers: {
                Authorization: `Bearer ${pluginConfig.apiKey}`,
                "Content-Type": "application/json"
    ...
    async function removeFileFromVectorStore(vectorStoreId: string, fileId: string): Promise<void> {
        const response = await fetch(`${getBase()}/vector_stores/${vectorStoreId}/files/${fileId}`, {
            method: "DELETE",
            headers: {
                Authorization: `Bearer ${pluginConfig.apiKey}`
            }
